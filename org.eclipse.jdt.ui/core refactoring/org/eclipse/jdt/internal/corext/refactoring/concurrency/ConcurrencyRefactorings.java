...
public final class ConcurrencyRefactorings extends NLS {
	...
	public static String AtomicInteger_todo_comment_statement_not_properly_synchronized;
	public static String AtomicInteger_todo_comment_statement_not_properly_synchronized_block;
	public static String AtomicInteger_todo_comment_statement_not_properly_synchronized_method;
