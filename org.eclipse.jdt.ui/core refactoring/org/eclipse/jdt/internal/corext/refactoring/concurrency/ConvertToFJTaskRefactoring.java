...
import org.eclipse.jdt.internal.corext.refactoring.util.ChecksAndResources;
...
public class ConvertToFJTaskRefactoring extends Refactoring {
	...
	private void createComputeMethod(TypeDeclaration recursiveActionSubtype, AST ast, RefactoringStatus result) {
		...
		try {
			...
			Statement lastStatementWithRecursiveCall= lastStatementWithRecursiveMethodInvocation.get(lastStatementWithRecursiveMethodInvocation.size() - 1);  //TODO Check to make sure this node exists?  Lines 427, 434, 486, 488
	...
	public Change createChange(IProgressMonitor pm) throws CoreException,
		...
		final FJTaskRefactoringDescriptor descriptor= new FJTaskRefactoringDescriptor(IJavaRefactorings.ENCAPSULATE_FIELD, project, description, comment, arguments, flags);  //TODO See below as well
